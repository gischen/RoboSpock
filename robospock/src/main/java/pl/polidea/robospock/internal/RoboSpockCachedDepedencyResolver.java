...
public class RoboSpockCachedDepedencyResolver implements DependencyResolver {
    ...
    RoboSpockCachedDepedencyResolver(DependencyResolver dependencyResolver, File cacheDir, long cacheValidTime) {
        this(dependencyResolver, new FileCache(cacheDir, cacheValidTime), new DefaultCacheNamingStrategy());
    }

    RoboSpockCachedDepedencyResolver(DependencyResolver dependencyResolver, Cache cache, CacheNamingStrategy cacheNamingStrategy) {
